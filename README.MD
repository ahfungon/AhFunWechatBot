...
2. 安装微信 `3.9.12.17`，下载地址在 https://github.com/lich0821/WeChatFerry/releases/tag/v39.4.2) 找到。
...
安装时记得选择安装中文语言包（chi_sim）
设置环境变量：
将 Tesseract-OCR 的安装路径添加到系统环境变量 PATH 中
默认路径通常是：C:\Program Files\Tesseract-OCR
