...
class StrategyAnalyzer:
    ...
    def analyze_strategy(self, text: str) -> str:
        ...
        try:
            ...
            response = requests.post(url, json={"strategy_text": text}, timeout=10)
            ...
            try:
                ...
                return "喵呜...策略分析服务返回了无效的数据..."
            
            # 检查响应状态
            if not isinstance(result, dict):
                self.logger.error(f"[策略分析] 无效的响应格式: {result}")
                return "喵呜...策略分析服务返回了错误的数据格式..."
    ...
    def save_strategy(self, strategy_data: dict) -> bool:
        ...
        try:
            ...
            response = requests.post(url, json=strategy_data, timeout=10)
